...
namespace bns
{
	...
	void ReadI32FromString(const char* string, bns::I32 start_index, bns::I32* out_end_index, bns::I32* out_integer);
	...
	/// <param name="start_index">Star index in string.</param>
	/// <param name="out_integer">Result if there is any. 0 if non found, but can also mean that 0 was encountered.</param>
	void ReadI32FromString(const char* string, bns::I32 start_index, bns::I32* out_integer);
